...
let username:string = "MashoodBilal"
let userPin: number = 1111
...
const result:Ans = await inquirer.prompt([
    {
        type: "input",
        name: "userId",
...
let balanceAmount:number = Math.floor(Math.random()*100000)
...
else {console.log(chalk.red(`Incorrect username or PIN`));
}
